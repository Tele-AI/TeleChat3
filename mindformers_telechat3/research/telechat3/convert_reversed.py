...
def name_replace(name: str):
    ...
    name = name.replace("attention.wo.weight", "self_attn.o_proj.weight")
    name = name.replace("attention.wq.weight", "self_attn.q_proj.weight")
    name = name.replace("attention.wk.weight", "self_attn.k_proj.weight")
    name = name.replace("attention.wv.weight", "self_attn.v_proj.weight")
